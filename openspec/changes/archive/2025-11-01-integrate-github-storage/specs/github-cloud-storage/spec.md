...
### Modified from existing spec: 故事保存与集成
**CHANGE**: The save mechanism SHALL transition from file download to cloud storage via GitHub API.
...
- **GIVEN** 用户希望保留本地副本
- **WHEN** 故事保存成功后
- **THEN** 系统可以提供可选的本地下载功能
- **AND** 下载的文件内容与云端文件相同

---

**Specification Version**: 1.0
**Related Capabilities**: ai-story (基线功能)
**Dependencies**:
